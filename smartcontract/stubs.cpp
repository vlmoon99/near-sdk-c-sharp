...
extern "C" int32_t __wasm_import_poll_pollable_drop(int32_t arg0) {
    return 0;
}

extern "C" int32_t __wasm_import_streams_input_stream_drop(int32_t arg0) {
    return 0;
}

extern "C" int32_t __wasm_import_streams_output_stream_drop(int32_t arg0) {
    return 0;
}

extern "C" int32_t __wasm_import_udp_udp_socket_drop(int32_t arg0) {
    return 0;
}

extern "C" int32_t __wasm_import_udp_incoming_datagram_stream_drop(int32_t arg0) {
    return 0;
}

extern "C" int32_t __wasm_import_udp_outgoing_datagram_stream_drop(int32_t arg0) {
    return 0;
}

extern "C" int32_t __wasm_import_tcp_tcp_socket_drop(int32_t arg0) {
    return 0;
}
